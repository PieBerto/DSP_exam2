  ...
  return (
    <>
      ...
      <PublicFilmTable films={films}
        deleteFilm={deleteFilm} updateFilm={updateFilm} refreshFilms={refreshFilms} filmSub={props.filmSub} filmReverseSub={props.filmReverseSub} switchDisabled={props.switchDisabled}/>
...
function ReviewLayout(props) {
  ...
  //Update the reviews after an MQTT message
  useEffect(() => {
    if(props.update !== undefined){
      setReviews((old)=>
        old.map((review)=>{
          if(Number(review.filmId) === Number(props.update.filmId) && Number(review.reviewerId) === Number(props.update.reviewerId)){
            return {
              filmId: Number(review.filmId),
              reviewerId: Number(review.reviewerId),
              completed: props.update.completed,
              rating: props.update.rating !== undefined ? props.update.rating : review.rating,
              review: props.update.review ? props.update.review : review.review,
              reviewDate: props.update.reviewDate ? props.update.reviewDate : review.reviewDate
            }
          }
          return review;
        })
    ...
    return (
      <>
        ...
        <FilmReviewTable reviews={reviews} film={film}
          ...
          reviewReverseSub={props.reviewReverseSub} reviewSub={props.reviewSub} 
