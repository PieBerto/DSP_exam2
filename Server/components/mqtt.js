...
const reviewMessageMap = new Map();
...
module.exports.publishReviewMessage = (filmId, reviewerId, message) => {
  mqtt_connection.publish(String(filmId)+"/"+String(reviewerId), JSON.stringify(message), { qos: 1 })
}
